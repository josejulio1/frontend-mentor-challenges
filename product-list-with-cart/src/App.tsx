...
function App() {
    ...
    return (
        <>
            <main className="bg-rose-50 max-md:px-8 md:px-8 lg:px-10 xl:px-32 max-lg:py-8 lg:py-16 grid max-md:grid-cols-1 md:grid-cols-2 lg:grid-cols-[2fr_1fr] gap-8">
